    ...
    modal.init = function (params) {
                    ...
                    function onBridgeReady() {
                        WeixinJSBridge.invoke('getBrandWCPayRequest', {
                            ...
                            if (res.err_msg == 'get_brand_wcpay_request:ok') {
                                /*
                                core.json('xfqf/wechat_complete', {logid: rjson.result.logid}, function (pay_json) {
                                    if (pay_json.status == 1) {
                                        FoxUI.toast.show('充值成功!');
                                        location.href = core.getUrl('xfqf.wechat_complete');
                                        return
                                    }
        ...
        $(document).on('click', '#btn-alipay', function () {
            ...
            core.json('xfqf/submit', {
                ...
                if (core.ish5app()) {
                    ...
                    location.href = core.getUrl('xfqf/alipay_complete')
                }
            }, true, true)
        });
        ...
        $(document).on('click', '#btn-credit', function () {
            ...
            core.json('xfqf/submit', {
                ...
                location.href = core.getUrl('xfqf.credits_complete');
                return
