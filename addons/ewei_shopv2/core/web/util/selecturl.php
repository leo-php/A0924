...
class Selecturl_EweiShopV2Page extends WebPage
{
	...
	public function main()
	{
		...
		if ($platform) {
			...
			$allUrls[0]["list"][] = array('name' => '多商户店铺', 'url_wxapp' => '/pages/changce/merch/index');
                        $allUrls[0]['list'][] = array('name' => '多商户入驻', 'url' => mobileUrl('', NULL, $full), 'url_wxapp' => '/pages/changce/merch/apply');
			$allUrls[0]['list'][] = array('name' => '积分签到', 'url' => mobileUrl('', NULL, $full), 'url_wxapp' => '/pages/changce/sign/index');
	...
	'list' => array(
		array('name' => '分销中心', 'url' => mobileUrl('commission', NULL, $full), 'url_wxapp' => '/pages/transfer/commission/index'),
