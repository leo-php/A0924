...
';
								$message = array(
									...
									'keyword3' => array('title' => '处理内容', 'value' => '成为分销商通知', 'color' => '#000000'),
									'remark'   => array('value' => '
感谢您的支持', 'color' => '#000000')
									);
								$toopenid = $openid;
...
';
									$message = array(
										...
										'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
										'keyword2' => array('title' => '处理进度', 'value' => '成为' . $set['texts']['agent'] . '通知', 'color' => '#000000'),
										'keyword3' => array('title' => '处理内容', 'value' => '成为队长通知', 'color' => '#000000'),
										'remark'   => array('value' => '
感谢您的支持', 'color' => '#000000')
										);
									$datas[] = array('name' => '昵称', 'value' => $data['nickname']);
...
';
										$message = array(
											...
											'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
											'keyword2' => array('title' => '处理进度', 'value' => '已提交', 'color' => '#000000'),
											'keyword3' => array('title' => '处理内容', 'value' => '您的商城会员提交了一笔提现，
金额:' . $data['dividend'] . ' 
 时间:' . $time . '
...
';
											$message = array(
												...
												'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
												'keyword2' => array('title' => '处理进度', 'value' => '团员成为队长通知', 'color' => '#000000'),
												'keyword3' => array('title' => '处理内容', 'value' => '您的团员在' . $time . '成为队长，他的下线不在为您提供分红', 'color' => '#000000'),
												'remark'   => array('value' => '
感谢您的支持', 'color' => '#000000')
												);
