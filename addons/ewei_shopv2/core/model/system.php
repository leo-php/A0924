...
class System_EweiShopV2Model
{
                ...
                if (!empty($submenu["items"])) {
                    foreach ($submenu["items"] as $i => $child) {
                        ...
                        if (empty($child["items"])) {
                            ...
                            $return_menu_child = array("title" => $child["title"], "items" => array());
    ...
    {
        $shopmenu = array("shop" => array("title" => "店铺", "subtitle" => "店铺首页", "icon" => "store", "items" => array(array("title" => "首页", "route" => "", "items" => array(array("title" => "幻灯片 ", "route" => "adv", "desc" => "店铺首页幻灯片管理"), array("title" => "导航图标", "route" => "nav", "desc" => "店铺首页导航图标管理"), array("title" => "广告", "route" => "banner", "desc" => "店铺首页广告管理"), array("title" => "魔方推荐", "route" => "cube", "desc" => "店铺首页魔方推荐管理"), array("title" => "商品推荐", "route" => "recommand", "desc" => "店铺首页商品推荐管理"), array("title" => "排版设置", "route" => "sort", "desc" => "店铺首页排版设置"))), array("title" => "商城", "items" => array(array("title" => "公告管理", "route" => "notice", "desc" => "店铺公告管理"), array("title" => "评价管理", "route" => "comment", "desc" => "店铺商品评价管理"), array("title" => "退货地址", "route" => "refundaddress", "desc" => "店铺退货地址管理"))), array("title" => "配送方式", "items" => array(array("title" => "普通快递", "route" => "dispatch", "desc" => "店铺普通快递管理"), array("title" => "同城配送", "route" => "cityexpress", "desc" => "店铺同城配送管理"))), array("title" => m("plugin")->getName("diypage"), "isplugin" => "diypage", "route" => "diypage", "top" => true))), "goods" => array("title" => "商品", "subtitle" => "商品管理", "icon" => "goods", "items" => array(array("title" => "出售中", "desc" => "出售中商品管理", "extend" => "goods.sale", "perm" => "goods.main"), array("title" => "已售罄", "route" => "out", "desc" => "已售罄/无库存商品管理", "perm" => "goods.main"), array("title" => "仓库中", "route" => "stock", "desc" => "仓库中商品管理", "perm" => "goods.main"), array("title" => "回收站", "route" => "cycle", "desc" => "回收站/已删除商品管理", "perm" => "goods.main"), array("title" => "待审核", "route" => "verify", "desc" => "多商户待审核商品管理", "perm" => "goods.main"), array("title" => "商品分类", "route" => "category"), array("title" => "商品组", "route" => "group"), array("title" => "标签管理", "route" => "label", "extend" => "goods.label.style"), array("title" => "固定信息", "route" => "fixedInfo"), array("title" => "虚拟卡密", "route" => "virtual", "iscom" => "virtual", "items" => array(array("title" => "虚拟卡密", "route" => "temp", "extend" => "goods.virtual.data"), array("title" => "卡密分类", "route" => "category"), array("title" => "设置", "route" => "set"))))), "member" => array("title" => "会员", "subtitle" => "会员管理", "icon" => "member", "items" => array(array("title" => "会员列表", "route" => "list", "route_in" => true), array("title" => "会员等级", "route" => "level"), array("title" => "区域代理审核", "route" => "areaRegister"),
//            array("title" => "线下进货审核", "route" => "linepayApply"),
            array("title" => "标签组", "route" => "group"), array("title" => "排行榜设置", "route" => "rank", "desc" => "会员积分/消费排行榜设置"),
            array("title" => "微信会员卡", "route" => "card", "iscom" => "wxcard", "extends" => array("member.card.post", "member.card.activationset")),
        )), "order" => array("title" => "订单", "subtitle" => "订单管理", "icon" => "order", "items" => array(array("title" => "待发货", "route" => "list.status1", "desc" => "待发货订单管理"), array("title" => "待收货", "route" => "list.status2", "desc" => "待收货订单管理"), array("title" => "待付款", "route" => "list.status0", "desc" => "待付款订单管理"), array("title" => "已完成", "route" => "list.status3", "desc" => "已完成订单管理"), array("title" => "已关闭", "route" => "list.status_1", "desc" => "已关闭订单管理"), array("title" => "全部订单", "route" => "list", "desc" => "全部订单列表", "permmust" => "order.list.main"), array("title" => "维权", "route" => "list", "items" => array(array("title" => "维权申请", "route" => "status4", "desc" => "维权申请管理"), array("title" => "维权完成", "route" => "status5", "desc" => "维权完成管理"))), array("title" => "工具", "items" => array(array("title" => "自定义导出", "route" => "export", "desc" => "订单自定义导出"), array("title" => "批量发货", "route" => "batchsend", "desc" => "订单批量发货"))))), "store" => array("title" => "门店", "subtitle" => "门店", "icon" => "mendianguanli", "items" => array(array("title" => "门店管理", "items" => array(array("title" => "门店管理", "route" => "", "extends" => array("store.diypage.settings", "store.diypage.page", "store.goods", "store.goods.goodsoption")), array("title" => "店员管理", "route" => "saler"), array("title" => "关键词设置", "route" => "set"))), array("title" => "门店商品管理", "items" => array(array("title" => "记次时商品管理", "route" => "verifygoods", "extends" => array("store.verifygoods.detail", "store.verifygoods.verifygoodslog")))), array("title" => "记次时商品统计", "route" => "verify.log"), array("title" => "核销订单记录", "route" => "verifyorder.log"))), "sale" => array("title" => "营销", "subtitle" => "营销设置", "icon" => "yingxiao", "items" => array(array("title" => "基本功能", "items" => array(array("title" => "满额立减", "route" => "enough", "desc" => "满额立减设置", "keywords" => "营销"), array("title" => "满额包邮", "route" => "enoughfree", "desc" => "满额包邮设置", "keywords" => "营销"), array("title" => "抵扣设置", "route" => "deduct", "desc" => "抵扣设置", "keywords" => "营销"), array("title" => "充值优惠", "route" => "recharge", "desc" => "充值优惠设置", "keywords" => "营销"), array("title" => "积分优惠", "route" => "credit1", "desc" => "积分优惠设置", "keywords" => "营销"), array("title" => "套餐管理", "route" => "package", "keywords" => "营销"), array("title" => "赠品管理", "route" => "gift", "keywords" => "营销"), array("title" => "全返管理", "route" => "fullback", "keywords" => "营销"), array("title" => "找人代付", "route" => "peerpay", "keywords" => "营销"), array("title" => "绑定送积分", "route" => "bindmobile"))), array("title" => "优惠券", "route" => "coupon", "iscom" => "coupon", "items" => array(array("title" => "全部优惠券"), array("title" => "手动发送", "route" => "sendcoupon", "desc" => "手动发送优惠券"), array("title" => "购物送券", "route" => "shareticket", "extends" => array("sale.coupon.goodssend", "sale.coupon.usesendtask", "sale.coupon.goodssend.add", "sale.coupon.usesendtask.add")), array("title" => "发放记录", "route" => "log", "desc" => "优惠券发放记录"), array("title" => "分类管理", "route" => "category", "desc" => "优惠券分类管理"), array("title" => "其他设置", "route" => "set", "desc" => "优惠券设置"))), array("title" => "微信卡券", "iscom" => "wxcard", "items" => array(array("title" => "卡券管理", "route" => "wxcard"))), array("title" => "其他工具", "items" => array(array("title" => "关注回复", "route" => "virtual"))))), "finance" => array("title" => "财务", "subtitle" => "财务管理", "icon" => "31", "items" => array(array("title" => "财务", "route" => "log", "items" => array(array("title" => "充值记录", "route" => "recharge"), array("title" => "提现申请", "route" => "withdraw"))), array("title" => "明细", "route" => "credit", "items" => array(array("title" => "积分明细", "route" => "credit1"), array("title" => "余额明细", "route" => "credit2"))), array("title" => "对账单", "items" => array(array("title" => "下载对账单", "route" => "downloadbill"))))), "statistics" => array("title" => "数据", "subtitle" => "数据统计", "icon" => "statistics", "items" => array(array("title" => "销售统计", "items" => array(array("title" => "销售统计", "route" => "sale"), array("title" => "销售指标", "route" => "sale_analysis"), array("title" => "订单统计", "route" => "order"))), array("title" => "商品统计", "items" => array(array("title" => "销售明细", "route" => "goods"), array("title" => "销售排行", "route" => "goods_rank"), array("title" => "销售转化率", "route" => "goods_trans"))), array("title" => "会员统计", "items" => array(array("title" => "消费排行", "route" => "member_cost"), array("title" => "增长趋势", "route" => "member_increase"))))), "app" => $this->pluginMenu("app"), "plugins" => array("title" => "应用", "subtitle" => "应用管理", "icon" => "plugins"), "sysset" => array("title" => "设置", "subtitle" => "商城设置", "icon" => "sysset", "items" => array(array("title" => "商城", "items" => array(array("title" => "基础设置", "route" => "shop"), array("title" => "关注及分享", "route" => "follow"), array("title" => "商城状态", "route" => "close"), array("title" => "模板设置", "route" => "templat"), array("title" => "全网通设置", "route" => "wap", "iscom" => "wap", "permcom" => "sms"))), array("title" => "交易", "items" => array(array("title" => "交易设置", "route" => "trade"), array("title" => "支付设置", "route" => "payset"), array("title" => "支付管理", "route" => "payment"))), array("title" => "消息推送", "items" => array(array("title" => "消息提醒", "route" => "notice"), array("title" => "自定义消息库", "route" => "tmessage"), array("title" => "微信模板库", "route" => "weixintemplate", "extend" => "sysset.weixintemplate.post"), array("title" => "消息通知队列", "route" => "notice_redis"))), array("title" => "短信配置", "route" => "sms", "iscom" => "sms", "items" => array(array("title" => "短信消息库", "route" => "temp"), array("title" => "短信接口设置", "route" => "set"))), array("title" => "小票打印机", "route" => "printer", "iscom" => "printer", "items" => array(array("title" => "打印机管理", "route" => "printer_list", "extends" => array("sysset.printer.printer_add")), array("title" => "打印机模板库"), array("title" => "打印设置", "route" => "set"))), array("title" => "其他", "items" => array(array("title" => "会员设置", "route" => "member"), array("title" => "分类层级", "route" => "category"), array("title" => "联系方式", "route" => "contact"), array("title" => "地址库设置", "route" => "area"), array("title" => "物流信息接口", "route" => "express"))), array("title" => "工具", "items" => array(array("title" => "七牛存储", "route" => "qiniu", "iscom" => "qiniu"), array("title" => "商品价格修复", "route" => "goodsprice"), array("title" => "模板消息修复", "route" => "templatetool"), array("title" => "清空海报缓存", "route" => "postertool"), array("title" => "支付证书验证", "route" => "wxpaycert"), array("title" => "七牛修复", "route" => "fixQiniu"))), array("title" => "入口", "route" => "cover", "items" => array(array("title" => "商城入口", "route" => "shop"), array("title" => "会员中心入口", "route" => "member"), array("title" => "订单入口", "route" => "order"), array("title" => "收藏入口", "route" => "favorite"), array("title" => "购物车入口", "route" => "cart"), array("title" => "优惠券入口", "route" => "coupon"))))));
        if (!p("app")) {
            unset($shopmenu["app"]);
        }
    ...
    {
        return array("plugin" => array("title" => "应用", "subtitle" => "应用管理", "icon" => "plugins", "items" => array(array("title" => "应用信息"), array("title" => "组件信息", "route" => "coms"), array("title" => "公众号权限", "route" => "perm"), array("title" => "站点小程序", "route" => "wxapp", "route" => "wxapp", "isplugin" => "app"), array("title" => "应用中心", "route" => "apps"), array("title" => "应用授权管理", "isplugin" => "grant", "items" => array(array("title" => "幻灯片管理", "route" => "pluginadv"), array("title" => "授权应用管理", "route" => "pluginmanage"), array("title" => "授权套餐管理", "route" => "pluginpackage"), array("title" => "销售记录", "route" => "pluginsale"), array("title" => "系统授权管理", "route" => "plugingrant"), array("title" => "授权管理设置", "route" => "pluginsetting"))))), "copyright" => array("title" => "版权", "subtitle" => "版权设置", "icon" => "banquan", "items" => array(array("title" => "手机端"), array("title" => "管理端", "route" => "manage"), array("title" => "公告管理", "items" => array(array("title" => "公告管理", "route" => "notice"))))), "data" => array("title" => "数据", "subtitle" => "数据管理", "icon" => "statistics", "items" => array(array("title" => "数据清理"), array("title" => "数据转移", "route" => "transfer"), array("title" => "计划任务", "items" => array(array("title" => "计划任务", "route" => "task"))), array("title" => "工具", "items" => array(array("title" => "七牛存储", "route" => "qiniu", "iscom" => "qiniu"))))), "site" => array("title" => "网站", "subtitle" => "网站设置", "icon" => "wangzhan", "items" => array(array("title" => "网站", "items" => array(array("title" => "基本设置"), array("title" => "幻灯片", "route" => "banner"), array("title" => "案例分类", "route" => "casecategory"), array("title" => "案例", "route" => "case"), array("title" => "友情链接", "route" => "link"))), array("title" => "文章", "items" => array(array("title" => "文章分类", "route" => "category"), array("title" => "文章管理", "route" => "article"))), array("title" => "内容", "items" => array(array("title" => "内容分类", "route" => "companycategory"), array("title" => "内容管理", "route" => "companyarticle"))), array("title" => "留言板", "items" => array(array("title" => "留言内容", "route" => "guestbook"))), array("title" => "设置", "items" => array(array("title" => "基础设置", "route" => "setting"))))), "auth" => array("title" => "授权", "subtitle" => "授权管理", "icon" => "iconfont-shouquan", "items" => array(array("title" => "授权管理"), array("title" => "系统更新", "route" => "upgrade"), array("title" => "历史日志", "route" => "upgrade.log"))));
    }
    /**
     * 获取 其他 菜单
     * @return array
    ...
    {
        return array("perm" => array("title" => "权限", "subtitle" => "权限系统", "icon" => "store", "items" => array(array("title" => "角色管理", "route" => "role"), array("title" => "操作员管理", "route" => "user"), array("title" => "操作日志", "route" => "log"))));
    }
    /**
     * 获取 插件 菜单
    ...
    {
        global $_W;
        $return_arr = array("system" => 0, "menu_title" => "", "menu_items" => array(), "logout" => "");
        if ($this->merch) {
    ...
    public function init()
    {
        ...
        $arr = array("merch" => $this->merch ? 1 : 0, "order1" => 0, "order4" => 0, "notice" => array(), "commission1" => 0, "commission2" => 0, "comment" => 0, "foldnav" => intval($_COOKIE["foldnav"]), "foldpanel" => intval($_COOKIE["foldpanel"]), "routes" => $routes, "funbar" => array("open" => intval($_W["shopset"]["shop"]["funbar"])), "right_menu" => $this->initRightMenu($routes));
    ...
    public function history_url()
    {
        ...
        if ($thispage) {
            $thispage_item = array(array("title" => $thispage["title"], "url" => $thispage["url"]));
