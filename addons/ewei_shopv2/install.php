...
CREATE TABLE `ims_ewei_shop_article_sys` (
  ...
  `article_close_advanced` tinyint(1) NOT NULL,
  PRIMARY KEY (`uniacid`),
...
CREATE TABLE `ims_ewei_shop_coupon` (
  ...
  `templateid` varchar(60) DEFAULT NULL,
  `isfriendcoupon` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
...
CREATE TABLE `ims_ewei_shop_coupon_data` (
  ...
  `friendcouponid` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `ims_ewei_shop_dividend_apply` (
  ...
  `dividend_pay` decimal(10,2) DEFAULT NULL,
  `content` text,
  `status` tinyint(3) DEFAULT NULL,
  `applytime` int(11) DEFAULT NULL,
  `checktime` int(11) DEFAULT NULL,
  `paytime` int(11) DEFAULT NULL,
  `invalidtime` int(11) DEFAULT NULL,
  `realmoney` decimal(10,2) DEFAULT NULL,
  `charge` decimal(10,2) DEFAULT NULL,
  `deductionmoney` decimal(10,2) DEFAULT NULL,
  `beginmoney` decimal(10,2) DEFAULT NULL,
  `endmoney` decimal(10,2) DEFAULT NULL,
  `alipay` varchar(50) NOT NULL,
  `bankname` varchar(50) NOT NULL,
  `bankcard` varchar(50) NOT NULL,
  `alipay1` varchar(50) NOT NULL,
  `bankname1` varchar(50) NOT NULL,
  `bankcard1` varchar(50) NOT NULL,
  `realname` varchar(50) NOT NULL,
  `sendmoney` decimal(10,2) DEFAULT NULL,
  `senddata` text,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_mid` (`mid`),
...
CREATE TABLE `ims_ewei_shop_member` (
  ...
  `headsstatus` tinyint(1) NOT NULL,
  `headstime` int(11) NOT NULL,
  `headsid` int(11) NOT NULL,
  `diyheadsid` int(11) NOT NULL,
  `diyheadsdata` text,
  `diyheadsfields` text,
  `applyagenttime` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
...
CREATE TABLE `ims_ewei_shop_member_card_buysend` (
  ...
  `card_points` varchar(50) DEFAULT NULL,
  `card_couponid` int(11) NOT NULL,
  `card_couponcount` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_openid` (`openid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_member_card_order` (
  ...
  `apppay` tinyint(3) NOT NULL,
  `borrowopenid` varchar(50) DEFAULT NULL,
  `isborrow` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_member_card_uselog` (
  ...
  `dec_price` decimal(11,2) NOT NULL,
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_openid` (`openid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_ewei_shop_member_wxapp_message_template_type` (
  ...
  `templatecode` varchar(255) DEFAULT NULL,
  `templatename` varchar(255) DEFAULT NULL,
  `keyword_id_list` varchar(255) DEFAULT NULL,
  `typegroup` varchar(255) DEFAULT NULL,
...
CREATE TABLE `ims_ewei_shop_order` (
  ...
  `dividend` text,
  `dividend_applytime` int(11) NOT NULL,
  `dividend_checktime` int(11) NOT NULL,
  `dividend_paytime` int(11) NOT NULL,
  `dividend_invalidtime` int(11) NOT NULL,
  `dividend_deletetime` int(11) NOT NULL,
  `dividend_status` tinyint(3) NOT NULL,
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('39', '44', 'polyapi', 'tool', '进销存-网店管家', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/polyapi.jpg', '', '0', '0', '1');
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('41', '46', 'pc', 'sale', 'PC端', '1.0', '易福', '1', '../addons/ewei_shopv2/static/images/pc.jpg', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('42', '47', 'live', 'sale', '互动直播', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/live.jpg', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('43', '48', 'invitation', 'sale', '邀请卡', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/invitation.png', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('44', '46', 'app', 'help', '小程序', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/app.jpg', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('45', '50', 'universalform', 'sale', '调研报名', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/dy.jpg', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('46', '51', 'cycelbuy', 'sale', '周期购', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/cycelbuy.jpg', '', '0', '0', '1');
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('48', '53', 'merchmanage', 'biz', '多商户手机端管理', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/merchmanage.jpg', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('49', '54', 'membercard', 'sale', '付费会员卡', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/membercard.png', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('50', '55', 'friendcoupon', 'biz', '好友瓜分券', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/friendcoupon.png', null, '0', '0', '1');
