...
class Index_EweiShopV2Page extends WebPage 
{
	...
	public function search() 
	{
		...
		if( !empty($keyword) ) 
		{
			...
			{
				if( $v["url"] == "http://www.efwww.com/web/index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=shop.diypage" ) 
				{
					$v["url"] = "http://www.efwww.com/web/index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=diypage";
				}
			}
			);
			if( empty($history) ) 
