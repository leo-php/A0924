...
if ($_W["ispost"]) {
    ...
    $data['double_credit'] = intval($_GPC['double_credit']);
    $data['rebuy_double_credit'] = intval($_GPC['rebuy_double_credit']);
    $data['rebuy_speed'] = $_GPC['rebuy_speed'];
    if ($data["total"] === -1) {
        $data["total"] = 0;
        $data["totalcnf"] = 2;
    }
    ...
    //增加普通会员包邮
    $data['free_shipping']=$_GPC['free_shipping'];
    if (empty($id)) {
        $data["merchid"] = 0;
