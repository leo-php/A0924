...
class Common_EweiShopV2Model {
    ...
    public function h5_wechat_build($params, $wechat, $type = 0)
    {
        ...
        $package['device_info'] = 'vslai_shop';
        $package['attach'] = $_W['uniacid'] . ':' . $type;
        $package['out_trade_no'] = $params['tid'];
        $package['total_fee'] = $params['fee'] * 100;
        $package['spbill_create_ip'] = CLIENT_IP;
        $package['notify_url'] = $_W['siteroot'] . 'addons/vslai_shop/payment/wechat/h5notify.php';
        ...
        $wOpt['signType'] = 'MD5';
        $returnurl = urlencode($this->createMobileUrl('shop/pay_h5weixin', array('orderid' => $params['orderid'])));
        $wOpt['mweb_url'] = $xml->mweb_url;

        $wOpt['mweb_url'] = $wOpt['mweb_url'][0] . '&redirect_url=' . $returnurl;
