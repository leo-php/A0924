...
class MobilePage extends Page
{
    ...
    public function __construct()
    {
        ...
        //获取当前用户
        $member = m('member')->checkMember($_GPC['mid']);
        ...
        if (!empty($diypagedata)) {
            ...
            if (!empty($diypageid)) {
                ...
                if (!empty($page)) {
                    ...
                    $i = 0;
                    foreach ($diyitems as $k => $v) {
                        if ($k == 'M1562825512583') {
                            array_splice($diyitems, $i, 0, array('66666666' => array (
                                'style' =>
                                    array (
                                        'margintop' => '8',
                                        'background' => '#ffffff',
...
//                                            array (
//                                                'text' => '推广二维码',
//                                                'linkurl' => mobileUrl("commission/qrcode"),
//                                                'iconclass' => 'icon-erweima1',
//                                                'remark' => '',
//                                                'dotnum' => '',
//                                            ),
//                                    ),
